...
export default function C044() {
  return (
    <Layout title="ST3215 C044" description="ST3215 C044 — High-speed intelligent servo, 0.10s/60°">
      <main className="container margin-vert--lg" style={{maxWidth: 800}}>
        ...
        <p style={{fontSize: '1.05rem', color: '#64748b', lineHeight: 1.7}}>High-speed variant, optimized speed response, suitable for fast motion control scenarios.</p>
        <h2 style={{marginTop: '2.5rem', fontSize: '1.4rem', fontWeight: 700}}>Technical Specifications</h2>
        <table><tbody>
          <tr><td>Torque</td><td>10 kg·cm</td></tr>
          <tr><td>Speed</td><td>0.10 s/60°</td></tr>
          <tr><td>Accuracy</td><td>0.2°</td></tr>
          <tr><td>Voltage</td><td>6V - 12V</td></tr>
          <tr><td>Communication</td><td>RS485 Bus</td></tr>
          <tr><td>Weight</td><td>78g</td></tr>
        </tbody></table>
        <div style={{textAlign: 'right', marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid #e2e8f0'}}>
          <Link to="/docs/servos/st3215-c044" className="button button--primary">📖 View Tutorial →</Link>
        </div>
      </main>
    </Layout>
  );
