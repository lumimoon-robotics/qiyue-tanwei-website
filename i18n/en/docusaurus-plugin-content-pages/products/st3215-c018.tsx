...
export default function C018() {
  return (
    <Layout title="ST3215 C018" description="ST3215 C018 — Standard intelligent bus servo, 15kg·cm">
      <main className="container margin-vert--lg" style={{maxWidth: 800}}>
        ...
        <p style={{fontSize: '1.05rem', color: '#64748b', lineHeight: 1.7}}>Standard intelligent bus servo, balancing torque and speed, suitable for general-purpose robot joints.</p>
        <h2 style={{marginTop: '2.5rem', fontSize: '1.4rem', fontWeight: 700}}>Technical Specifications</h2>
        <table><tbody>
          <tr><td>Torque</td><td>15 kg·cm</td></tr>
          <tr><td>Speed</td><td>0.15 s/60°</td></tr>
          <tr><td>Accuracy</td><td>0.3°</td></tr>
        ...
        <div style={{textAlign: 'right', marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid #e2e8f0'}}>
          <Link to="/docs/servos/st3215-c018" className="button button--primary">📖 View Tutorial →</Link>
        </div>
      </main>
    </Layout>
  );
