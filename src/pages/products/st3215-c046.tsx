...
export default function C046() {
  return (
    <Layout title="ST3215 C046" description="ST3215 C046 — 高精度智能舵机，±0.15°">
      <main className="container margin-vert--lg" style={{maxWidth: 800}}>
        ...
        <p style={{fontSize: '1.05rem', color: '#64748b', lineHeight: 1.7}}>高精度型，±0.15° 控制精度，适合精密定位场景。</p>
        <h2 style={{marginTop: '2.5rem', fontSize: '1.4rem', fontWeight: 700}}>技术规格</h2>
        <table><tbody>
          <tr><td>扭矩</td><td>18 kg·cm</td></tr>
          <tr><td>速度</td><td>0.13 s/60°</td></tr>
          <tr><td>精度</td><td>0.15°</td></tr>
          <tr><td>电压</td><td>6V - 12V</td></tr>
          <tr><td>通信</td><td>RS485 总线</td></tr>
          <tr><td>重量</td><td>90g</td></tr>
        </tbody></table>
        <div style={{textAlign: 'right', marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid #e2e8f0'}}>
          <Link to="/docs/servos/st3215-c046" className="button button--primary">📖 查看教程 →</Link>
        </div>
      </main>
    </Layout>
  );
